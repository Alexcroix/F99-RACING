...
public class ALIyerEdonAssets_Lighting : EditorWindow
{
    ...
    void OnEnable()
    {
        ...
        if (EditorPrefs.GetInt("dontShow_White_City") == 3)
            dontShow = true;
        if (EditorPrefs.GetInt("dontShow_White_City") != 3)
            dontShow = false;
    ...
    private void OnGUI()
    {
        ...
        {
            if (dontShow == true)            
                EditorPrefs.SetInt("dontShow_White_City", 3); // 3 == true
            if (dontShow == false)
                EditorPrefs.SetInt("dontShow_White_City", 0); // 0 = false
        }
...
public class Startup
{
    static Startup() 
    {
        EditorPrefs.SetInt("showCounts_White_City", EditorPrefs.GetInt("showCounts_White_City") + 1);
        if (EditorPrefs.GetInt("showCounts_White_City") < 2)
        { 
        ...
        {   
            if (EditorPrefs.GetInt("dontShow_White_City") == 3)
            {
                if (EditorPrefs.GetInt("showCounts_White_City") >= 210)
                    EditorPrefs.SetInt("showCounts_White_City", 0);
            }
            else
            {
                if (EditorPrefs.GetInt("showCounts_White_City") >= 50)
                    EditorPrefs.SetInt("showCounts_White_City", 0);
            }
        }            
    }
